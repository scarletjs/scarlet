...
function ProxyInfo(instance, memberName){
	...
	// TODO: Once we can automatically identify the member we are intercepting than 
	// 		 We should be able to automagically implement interception without diversifying 
	//		 our API.

	self._isMethod = function(){
